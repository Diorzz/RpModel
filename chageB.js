...
var option = {
	title: {
		text: 'Seller Utility',
		subtext:'Buyer is not change, seller change honest'
	},
	tooltip: {},
	legend: {
	...
	series: [{
		...
		type: 'line',
		smooth: true,
		data: [sumprice(price1), sumprice(price2), sumprice(price3), sumprice(price4), sumprice(price5), sumprice(price6), sumprice(price7), sumprice(price8), sumprice(price9)]
	}]
};
...
console.log(badTransactions1[2])