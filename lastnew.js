function createOrder(rate) {
	...
	for (var j = 0; j < 50000; j++) {
		...
		//console.log(currentBuyer.Cj+","+Transaction.truePrice)
		if (Transaction.buyer.BID == 3) {
			//console.log(currentSeller.honesty+" , "+currentSeller.SID)
			//console.log(Transaction.buyer.BID+" => "+Transaction.seller.SID+" ,"+currentBuyer.Cj)
		}
